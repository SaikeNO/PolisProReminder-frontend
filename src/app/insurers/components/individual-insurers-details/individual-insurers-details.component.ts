...
@Component({
  selector: 'app-individual-insurers-details',
  standalone: true,
  imports: [
    MatCardModule,
    MatListModule,
  ...
  templateUrl: './individual-insurers-details.component.html',
  styleUrl: './individual-insurers-details.component.scss',
})
export class IndividualInsurersDetailsComponent {
  private injector = inject(Injector);
  private portalService = inject(PortalService);

  constructor(@Inject(INSURER_DETAILS) public insurer: IndividualInsurer | undefined) {}
